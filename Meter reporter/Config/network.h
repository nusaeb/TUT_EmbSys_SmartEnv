#ifndef METER_REPORTER_CONFIG_NETWORK_H_
#define METER_REPORTER_CONFIG_NETWORK_H_
...
// Node address
#define ADDR_LOCAL		0x14	// Local Node address
...
#endif /* METER_REPORTER_CONFIG_NETWORK_H_ */
